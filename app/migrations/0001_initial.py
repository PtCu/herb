# Generated by Django 3.0.3 on 2020-10-07 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_date', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 22, 55, 0, 231227))),
            ],
            options={
                'db_table': 'User',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ('time', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 22, 55, 0, 235227))),
                ('incubator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Incubator')),
            ],
            options={
                'db_table': 'FixList',
