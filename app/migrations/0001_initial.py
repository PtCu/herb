# Generated by Django 3.1.1 on 2020-10-11 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_date', models.DateTimeField(default=datetime.datetime(2020, 10, 11, 12, 33, 21, 821673))),
            ],
            options={
                'db_table': 'User',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ('time', models.DateTimeField(default=datetime.datetime(2020, 10, 11, 12, 33, 21, 821673))),
                ('incubator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.incubator')),
            ],
            options={
                'db_table': 'FixList',
